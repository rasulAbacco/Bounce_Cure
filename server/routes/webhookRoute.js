        ...
        switch (event.event) {
          ...
          case "open": {
            ...
            if (!existingOpen) {
              ...
              console.log(`⏭️  Duplicate open ignored: ${event.email}`);
            }
            break;
          }
          ...
          case "click": {
            ...
            if (!existingClick) {
              ...
              console.log(
                `🖱️  Click tracked: ${event.email} → ${event.url} (Campaign ${parsedCampaignId})`
              );
            } else {
              console.log(`⏭️  Duplicate click ignored: ${event.email}`);
            }
            break;
          }
