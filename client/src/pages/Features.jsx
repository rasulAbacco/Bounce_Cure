    ...
    <div className="bg-black text-white font-sans min-h-screen overflow-hidden">
      ...
      <section className="text-center py-14 px-4 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent animate-fade-in">
            Powerful Features
          </h1>
...
<section className="py-0 px-4 bg-gradient-to-r from-gray-900 to-black">
  <div className="max-w-7xl mx-auto">
    <div className="text-center mb-16">
      ...
      <p className="text-gray-400 text-lg">Everything you need for professional email verification</p>
    </div>
      ...
      {[
        {
          ...
          image: "/placeholder.svg?height=200&width=300&text=Real-time+Verification"
        },
        {
          ...
          image: "/placeholder.svg?height=200&width=300&text=Security+Shield"
        },
        {
        ...
        },
        {
          ...
          image: "/placeholder.svg?height=200&width=300&text=Bulk+Processing"
        },
        {
          ...
          image: "/placeholder.svg?height=200&width=300&text=Global+Network"
        },
        {
          ...
          image: "/placeholder.svg?height=200&width=300&text=API+Integration"
        }
      ].map((feature, i) => (
        <div
          key={i}
        ...
        >
          <div className="mb-4">
            <img
              ...
              alt={feature.title}
              className="w-full h-40 object-cover rounded-lg mb-4 group-hover:scale-110 transition-transform duration-500 border border-white/20"
            />
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <img 
                  src="/placeholder.svg?height=400&width=500&text=AI+Detection+Engine"
                  alt="AI Detection"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                <img 
                  src="/placeholder.svg?height=400&width=500&text=Real-time+Dashboard"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <img 
                  src="/placeholder.svg?height=400&width=500&text=Cloud+Infrastructure"
