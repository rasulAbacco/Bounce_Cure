      ...
      <div className="bg-white rounded-lg w-full max-w-2xl p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              type="text" 
              className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:border-[#c2831f] focus:outline-none"
          ...
          <div>
            ...
            <select className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:border-[#c2831f] focus:outline-none">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-black mt-1">12.5K</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-black mt-1">42.3%</p>
              </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredCampaigns.map((campaign) => (
                  <tr key={campaign.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-black">{campaign.opens}</div>
                      <div className="text-xs text-gray-500">
                        {campaign.sent > 0 ? ((campaign.opens / campaign.sent) * 100).toFixed(1) : 0}%
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-black">{campaign.clicks}</div>
                      <div className="text-xs text-gray-500">
