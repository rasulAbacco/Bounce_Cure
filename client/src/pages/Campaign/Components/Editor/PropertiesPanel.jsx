...
const PropertiesPanel = ({
  ...
  const getElementIcon = (elementType, size = 14) => {
    ...
    switch (elementType) {
      ...
      case "subheading":
        return <Type {...iconProps} className="text-purple-400" />;
      case "paragraph":
        return <Type {...iconProps} className="text-green-400" />;
      case "blockquote":
        return <FileText {...iconProps} className="text-yellow-400" />;
      case "button":
        return <Square {...iconProps} className="text-orange-400" />;
      case "card":
        return <CreditCard {...iconProps} className="text-indigo-400" />;
      case "rectangle":
        return <Square {...iconProps} className="text-purple-400" />;
      case "circle":
        return <Circle {...iconProps} className="text-pink-400" />;
      case "triangle":
        return <Triangle {...iconProps} className="text-green-400" />;
      case "star":
        return <Star {...iconProps} className="text-yellow-400" />;
      case "hexagon":
        return <Hexagon {...iconProps} className="text-blue-400" />;
      case "arrow":
        return <ArrowRight {...iconProps} className="text-red-400" />;
      case "line":
        return <Minus {...iconProps} className="text-yellow-400" />;
      case "image":
        return <Image {...iconProps} className="text-indigo-400" />;
      case "video":
        return <Video {...iconProps} className="text-red-400" />;
      case "audio":
        return <Music {...iconProps} className="text-green-400" />;
      case "frame":
        return <Frame {...iconProps} className="text-gray-400" />;
      case "input":
        return <PenTool {...iconProps} className="text-indigo-400" />;
      case "checkbox":
        return <Hash {...iconProps} className="text-teal-400" />;
      case "icon":
        return <Star {...iconProps} className="text-yellow-400" />;
      case "social":
        return <Star {...iconProps} className="text-blue-400" />;
      default:
        return <Square {...iconProps} className="text-gray-400" />;
    }
  };
  return (
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                {selectedElementData.animation &&
                  selectedElementData.animation !== "none" && (
                    <>
                      <div>
                        <label className="block text-sm text-gray-400 mb-1">
                          Duration (s)
