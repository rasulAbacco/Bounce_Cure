  ...
  const smsPlans = [
    {
      ...
      icon: Target, color: 'text-[#c2831f]', borderColor: 'border-yellow-500', bgGradient: 'from-yellow-500/40',
    ...
    },
    {
      ...
      icon: Shield, color: 'text-[#c2831f]', borderColor: 'border-yellow-500', bgGradient: 'from-yellow-500/20',
    ...
    },
    {
      ...
      icon: Send, color: 'text-[#c2831f]', borderColor: 'border-yellow-500', bgGradient: 'from-yellow-500/20',
  ...
  return (
    <div className="min-h-screen text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="mb-8">
          <button onClick={onClose} className="flex items-center text-gray-300 hover:text-white transition-colors group">
