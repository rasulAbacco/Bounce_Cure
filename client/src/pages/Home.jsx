      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="bg-gray-50 rounded-lg p-8">
          <div className="rounded-lg shadow-lg overflow-hidden">
            <img src={mailveri} alt="Mail Verification" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="py-16 px-6 md:px-20">
    ...
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
      ...
      <div className="flex justify-center">
        <img
          src="https://kickbox.com/assets/pages/deliverability-services/consulting-5329f7a9f68f528c5bcdaa981c038ac076e998c29393ac3584aa66735fb87907c24904219556dbdab31989a2f36483e1f37c0a218a24570ac6b070d6b2c1dcee.svg"
          alt="Video Meeting"
