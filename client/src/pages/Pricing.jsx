  ...
  <div className="min-h-screen p-6   text-white">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-[#c2831f] mb-4">Pricing Calculator</h1>
      ...
      {/* Slots Input */}
      <div className="flex justify-center mb-8">
        <div className="bg-gray-900 rounded-xl p-6 shadow-lg border border-gray-700 max-w-md w-full">
          <label className="block text-sm font-medium text-[#c2831f] mb-2">
            Number of Slots
          </label>
          <input
            type="number"
            ...
            className="w-full px-4 py-3 border border-gray-700 rounded-lg focus:ring-2 focus:ring-[#c2831f] focus:border-transparent text-lg font-semibold text-center bg-black text-white"
          />
        ...
        <div className="bg-gray-900 rounded-2xl shadow-xl border border-gray-700 overflow-hidden">
          <div className="p-8">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 bg-orange-900 text-orange-300 text-xs px-2 py-1 rounded-full font-medium">
                Most Advanced
              </span>
            </div>
            <p className="text-gray-400 mb-6">
